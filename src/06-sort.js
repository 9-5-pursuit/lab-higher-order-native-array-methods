...
function sortByRuntimeAscending(songs) {
  ...
  let sortedSong = songs.sort((a,b)=> a.runtimeInSeconds - b.runtimeInSeconds);
   return sortedSong
}
 ...
 * @returns {Object[]}
 */
function sortBySongTitleAscending(songs) {  let sortedSong = songs.sort((a,b)=>{
