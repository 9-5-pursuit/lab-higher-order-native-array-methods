 ...
 * @returns {boolean}
 */
const allSongsAreOverTwoMinutes = (songs) => songs.every((song) => songs.runtimeInSeconds > 120);
 ...
 * @returns {boolean}
 */
const anySongIsOverFourMinutes = (songs) => songs.some((song) => songs.runtimeInSeconds > 240);
 ...
 * @returns {boolean}
 */
const anySongIsByPeanut = (songs) => songs.some((songs) => songs.artist === "Peanut");
