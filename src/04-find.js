 ...
 */
const findPinkElephantsByTimestreet = (song) =>
  song.find((song) => song.title === "Pink Elephants");
 ...
 * @returns {Object} A single object.
 */
const findFirstSongUnderThreeMinutes = (song) =>
  song.find((song) => song.runtimeInSeconds < 3 * 60);
 ...
 * @returns {Object} A single object.
 */
const findFirstTitleTrack = (song) =>
  song.find((song) => song.title === song.album);
